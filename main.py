...
while session:
    choice = input("What would you like to do?\nRegister new player (r), update an existing player's data (u), delete a player's record (d), view all records (v) or exit (q)?\n")
    ...
    if choice == "r":
        ...
        player = input("Whose record would you like to delete: ")
